...
*Take up
/*
ivreg2 TVIP (public_34=min_center_34) $controls i.cohort i.comuna_cod, robust
weakivtest
...
reghdfe public_34 min_center_34 $controls, absorb(cohort#comuna_cod) vce(robust)
reghdfe hours_w_18 min_center_34 $controls, absorb(cohort#comuna_cod) vce(robust)
reghdfe TVIP min_center_34 $controls, absorb(cohort#comuna_cod) vce(robust)
