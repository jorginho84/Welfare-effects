...
twoway (histogram min_center_34 if min_center_34 <3, lwidth(medium) lcolor(blue) fcolor(blue*.4) yaxis(1)) ///
	(lpolyci public_34 min_u_34 if min_u_34 < 3 & min_u_34>0, degree(1) 	///
