...
putexcel set "$n_obs/N_obs_nonmissins_0913.xlsx", sheet("Testscores") modify
putexcel B2 = mat(T), colnames 

putexcel set "$n_obs/N_obs_nonmissins_0913.xlsx", sheet("Controls") modify
putexcel B2 = mat(C), colnames 

putexcel set "$n_obs/N_obs_nonmissins_0913.xlsx", sheet("Total_t67") modify
